        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <ul className="list-group">
              ...
              <Link to="/" className="list-item"><i className="fas fa-phone pr-1 text-success"></i><strong>Phone:</strong> 0868 770 572</Link >
              <Link to="/" className="list-item"><i className="fas fa-envelope pr-1 text-primary"></i><strong>Email:</strong> phanbaan89@gmail.com</Link >
              <Link to="/" className="list-item"><i className="fas fa-globe-asia pr-1 text-danger"></i><strong>Website:</strong> http://webmau247.com</Link >
            </ul>
          </div>
        </div>
      </div>
